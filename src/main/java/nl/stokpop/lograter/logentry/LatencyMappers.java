...
public class LatencyMappers {
     ...
     * @param messageField the field to use in message, the line mappers are applied to this message field
     */
    public static <T extends LogbackLogEntry> void initializeMappers(List<LogbackElement> elements, Map<String, LogEntryMapper<T>> mappers, String messageField) {
        ...
        mappers.put(messageField, messageEntryMapper);
