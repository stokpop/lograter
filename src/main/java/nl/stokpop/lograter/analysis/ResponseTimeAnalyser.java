 ...
 * 
 * This analyser is not thread safe.
 * 
 * Also make sure not to hand over the same counter to multiple analysers 
 * that can be analysed concurrently.
 */
@NotThreadSafe
public class ResponseTimeAnalyser {

	private static final Logger log = LoggerFactory.getLogger(ResponseTimeAnalyser.class);
	 ...
	 */
	public ResponseTimeAnalyser(RequestCounter counter) {
	 ...
	 */
    public ResponseTimeAnalyser(RequestCounter counter, TimePeriod timePeriod) {
